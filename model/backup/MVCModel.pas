...
type
  ...
  published
    property username: RawUtf8
      index 20 read fusername write fusername;
    property pwd: RawUtf8
      index 20 read fpwd write fpwd;
    property sex: RawUtf8
      index 6 read fsex write fsex;
       property address: RawUtf8
      index 30 read faddress write faddress;
    property age: RawUtf8
      index 4 read fage write fage;
    property idcard: RawUtf8
      index 20  read fidcard write fidcard;
     property realname: RawUtf8
      index 20 read frealname write frealname;
    property phone: RawUtf8
      index 16 read fphone write fphone;
    property roleid: RawUtf8
      index 12 read froleid write froleid;
    property uptime: RawUtf8
      index 11 read fuptime write fuptime;
  end;
