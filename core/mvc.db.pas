...
uses  Generics.Collections, mvc.Config, mvc.JSON, MVC.DataSet,mysql57conn,mvc.dbMySql57;
...

{
  type
    TDBConns = class
    private
      ConnList: specialize TCustomList<TMySQL57Connection>;
    public
      function findDb(DbName: string): TMySQL57Connection; //找对应名称的数据库链接
      constructor Create();
    ...
    public
     ...
     //
      ...
      function GetFirstConn: TMySQL57Connection;
  ...
  function TDBItem.GetFirstConn: TMySQL57Connection;
  begin
  ...
  function TDBConns.findDb(DbName: string): TMySQL57Connection;
  var
    i: integer;
  begin
    Result := nil;
