...
function TBrookHTTPUpload.Save(AOverwritten: boolean; out AError: string): boolean;
var
  R: cint;
begin
  SgLib.Check;
...
function TBrookHTTPUpload.SaveAs(const APath: TFileName; out AError: string): boolean;
begin
