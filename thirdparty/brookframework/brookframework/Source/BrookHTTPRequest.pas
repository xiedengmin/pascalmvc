...
{$IFNDEF FPC}
  ...
  TBrookHTTPRequestIsolatedAnonymousProc = reference to procedure (
    ARequest: TBrookHTTPRequest; AResponse: TBrookHTTPResponse; AUserData: Pointer);
...
class procedure TBrookHTTPRequest.DoRequestIsolatedAnonymousProcCallback(Acls: Pcvoid;
  Areq: Psg_httpreq; Ares: Psg_httpres);
var
...
class function TBrookHTTPRequest.CreateResponse(AHandle: Pointer): TBrookHTTPResponse;
begin
...
procedure TBrookHTTPRequest.Isolate(
  const AProc: TBrookHTTPRequestIsolatedAnonymousProc;
  AUserData: Pointer);
var
  VHolder: TBrookHTTPReqIsolatedProcHolder<TBrookHTTPRequestIsolatedAnonymousProc>;
begin
