...
// (DO NOT EDIT: machine generated header) 'crcontrols270.dpk' rev: 34.00 (Windows)

#ifndef Crcontrols270HPP
#define Crcontrols270HPP
...
namespace Crcontrols270
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Crcontrols270 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_CRCONTROLS270)
using namespace Crcontrols270;
#endif
#pragma pack(pop)
#pragma option pop
