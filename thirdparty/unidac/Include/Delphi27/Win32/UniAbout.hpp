...
// (DO NOT EDIT: machine generated header) 'UniAbout.pas' rev: 34.00 (Windows)
...
class DELPHICLASS TUniDacAboutForm;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TUniDacAboutForm : public Vcl::Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TUniDacAboutForm(System::Classes::TComponent* AOwner) : Vcl::Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TUniDacAboutForm(System::Classes::TComponent* AOwner, int Dummy) : Vcl::Forms::TForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TUniDacAboutForm() { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TUniDacAboutForm(HWND ParentWindow) : Vcl::Forms::TForm(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UNIABOUT)
using namespace Uniabout;
#endif
#pragma pack(pop)
#pragma option pop
