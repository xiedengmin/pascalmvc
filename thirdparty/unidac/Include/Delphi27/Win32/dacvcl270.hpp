...
// (DO NOT EDIT: machine generated header) 'dacvcl270.dpk' rev: 34.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DACVCL270)
using namespace Dacvcl270;
#endif
#pragma pack(pop)
#pragma option pop
