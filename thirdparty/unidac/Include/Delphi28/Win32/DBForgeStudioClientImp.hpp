...
// (DO NOT EDIT: machine generated header) 'DBForgeStudioClientImp.pas' rev: 35.00 (Windows)

#ifndef DbforgestudioclientimpHPP
#define DbforgestudioclientimpHPP
...
namespace Dbforgestudioclientimp
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TDBForgeStudioServiceEvents;
class DELPHICLASS TDBForgeStudioService;
class DELPHICLASS TDACSqlEditorFrameFS;
class DELPHICLASS TSourceNotifierFS;
class DELPHICLASS TSqlSourceFS;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TDBForgeStudioServiceEvents : public System::TInterfacedObject
{
...
public:
	...
	__property System::Classes::TNotifyEvent Deactivate = {read=FOnDeactivate, write=FOnDeactivate};
public:
	/* TObject.Create */ inline __fastcall TDBForgeStudioServiceEvents() : System::TInterfacedObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDBForgeStudioServiceEvents() { }
	
private:
	void *__IDbForgeServiceEvents;	// Dbtoolsintf::IDbForgeServiceEvents 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {55CBF937-D3F9-486F-B34A-A435F4B9FCCC}
	operator Dbtoolsintf::_di_IDbForgeServiceEvents()
	{
		Dbtoolsintf::_di_IDbForgeServiceEvents intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Dbtoolsintf::IDbForgeServiceEvents*(void) { return (Dbtoolsintf::IDbForgeServiceEvents*)&__IDbForgeServiceEvents; }
	#endif
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TDBForgeStudioService : public Dbtoolsclient::TCustomDBToolsService
{
	typedef Dbtoolsclient::TCustomDBToolsService inherited;
	
	
private:
	typedef System::DynamicArray<Dbtoolsclient::TCompareFlag> _TDBForgeStudioService__1;
	
	typedef System::DynamicArray<Dbtoolsclient::TParamTypeMap> _TDBForgeStudioService__2;
	
	
private:
	void __fastcall OnServerDeactivate(System::TObject* Sender);
	
protected:
	System::Classes::TStringList* FUsedConnectionStrList;
	_TDBForgeStudioService__1 FUsedConnectionCompareFlags;
	...
	Dbtoolsintf::_di_IDbForgeService FSqlService;
	_TDBForgeStudioService__2 FParamTypeMaps;
	TDBForgeStudioServiceEvents* FDBForgeStudioServiceEvents;
	...
	TSqlSourceFS* __fastcall GetSqlSource(System::Classes::TComponent* Component, Designintf::_di_IDesigner Designer, System::UnicodeString SqlTextPrefix = System::UnicodeString(), Dbaccess::TStatementType StatementType = (Dbaccess::TStatementType)(0x0));
...
public:
	__fastcall virtual TDBForgeStudioService(Dadesignutils::TDADesignUtilsClass ADADesignUtils, System::_di_IInterface ASqlService, System::UnicodeString ADefaultConnectionStr);
	__fastcall virtual ~TDBForgeStudioService();
	Data::Db::TFieldType __fastcall DBForgeStudioTypeToDataType(int AType, Data::Db::TFieldType OldType);
	int __fastcall DataTypeToDBForgeStudioType(Data::Db::TFieldType AType);
	...
	__property Dbtoolsintf::_di_IDbForgeService SqlService = {read=FSqlService};
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TDACSqlEditorFrameFS : public Dbtoolsclient::TCustomDACSqlEditorFrame
{
	typedef Dbtoolsclient::TCustomDACSqlEditorFrame inherited;
	
	
private:
	typedef System::StaticArray<Dbtoolsintf::_di_ISqlEditor, 11> _TDACSqlEditorFrameFS__1;
	
	
private:
	TDBForgeStudioService* FDBToolsService;
	_TDACSqlEditorFrameFS__1 FSqlEditors;
...
public:
	__fastcall virtual TDACSqlEditorFrameFS(System::Classes::TComponent* AOwner, System::Classes::TComponent* Component, Dbtoolsclient::TCustomDBToolsService* DBToolsService);
	__fastcall virtual ~TDACSqlEditorFrameFS();
	virtual void __fastcall SetFocus();
	__property Dbtoolsintf::_di_ISqlEditor SqlEditor = {read=GetSqlEditor};
public:
	/* TWinControl.CreateParented */ inline __fastcall TDACSqlEditorFrameFS(HWND ParentWindow) : Dbtoolsclient::TCustomDACSqlEditorFrame(ParentWindow) { }
	
};


#pragma pack(push,4)
class PASCALIMPLEMENTATION TSourceNotifierFS : public Dbtoolsclient::TCustomSourceNotifier
{
...
public:
	/* TCustomSourceNotifier.Create */ inline __fastcall virtual TSourceNotifierFS() : Dbtoolsclient::TCustomSourceNotifier() { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TSourceNotifierFS() { }
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TSqlSourceFS : public Dbtoolsclient::TCustomSqlSource
{
	typedef Dbtoolsclient::TCustomSqlSource inherited;
	
	
private:
	typedef System::DynamicArray<bool> _TSqlSourceFS__1;
	
	
protected:
	int FParameterCount;
	_TSqlSourceFS__1 FParameterSetted;
...
public:
	__fastcall TSqlSourceFS(TDBForgeStudioService* DBToolsService, System::Classes::TComponent* Component, Designintf::_di_IDesigner Designer, Dbaccess::TStatementType StatementType);
	__fastcall virtual ~TSqlSourceFS();
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DBFORGESTUDIOCLIENTIMP)
using namespace Dbforgestudioclientimp;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// DbforgestudioclientimpHPP
