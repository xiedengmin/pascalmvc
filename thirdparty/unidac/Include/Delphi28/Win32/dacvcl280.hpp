...
// (DO NOT EDIT: machine generated header) 'dacvcl280.dpk' rev: 35.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DACVCL280)
using namespace Dacvcl280;
#endif
#pragma pack(pop)
#pragma option pop
