...
// (DO NOT EDIT: machine generated header) 'dclcrcontrols280.dpk' rev: 35.00 (Windows)

#ifndef Dclcrcontrols280HPP
#define Dclcrcontrols280HPP
...
#include <CRGrid.hpp>	// (crcontrols280)
// PRG_EXT: .bpl
...
namespace Dclcrcontrols280
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclcrcontrols280 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLCRCONTROLS280)
using namespace Dclcrcontrols280;
#endif
#pragma pack(pop)
#pragma option pop
