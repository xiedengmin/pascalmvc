...
// (DO NOT EDIT: machine generated header) 'crcontrols280.dpk' rev: 35.00 (Windows)

#ifndef Crcontrols280HPP
#define Crcontrols280HPP
...
namespace Crcontrols280
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Crcontrols280 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_CRCONTROLS280)
using namespace Crcontrols280;
#endif
#pragma pack(pop)
#pragma option pop
