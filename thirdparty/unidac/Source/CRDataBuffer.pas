...
type
  ...
  public
    ...
    procedure Read(const Data: TValueArr; Offset, Count: Integer);
...
procedure TDataBuffer.Read(const Data: TValueArr; Offset, Count: Integer);
...
procedure TDataBuffer.Write(const Data: TValueArr; Offset, Count: Integer);
var
  cnt: Integer;
begin
  while Count > 0 do begin
