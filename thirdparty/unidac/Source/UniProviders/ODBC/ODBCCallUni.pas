...
{$ENDIF}
  ...
  {$IFNDEF UNIDACPRO}ODBCError, ODBCConsts,{$ELSE}ODBCErrorUni, ODBCConstsUni,{$ENDIF}
  CRTypes, CRFunctions;
...
//  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLColAttributeInt = function(
    ...
    BufferLength:         smallint;
    out StringLength:     smallint;
    out NumericAttribute: NativeInt
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLDataSources = function(
    ...
    out NameLength1:   smallint;
    Description:       IntPtr;
    BufferLength2:     smallint;
    out NameLength2:   smallint
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLDescribeCol = function(
    ...
    ColumnName:        IntPtr;
    BufferLength:      smallint;
    out NameLength:    smallint;
    out DataType:      smallint;
    out ColumnSize:    NativeUInt;
    out DecimalDigits: smallint;
    out Nullable:      smallint
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLGetConnectAttrInt = function(
    ConnectionHandle: TSQLHDbc;
    Attribute:        integer;
    out ValuePtr:     integer;
    BufferLength:     integer;
    StringLength:     IntPtr
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  _SQLGetConnectAttr = function(
    ConnectionHandle: TSQLHDbc;
    Attribute:        integer;
    ValuePtr:         IntPtr;
    BufferLength:     integer;
  ...
  _SQLGetDescRec = function(
    ...
    out StringLength: smallint;
    out _Type:        smallint;
    out SubType:      smallint;
    out Length:       NativeInt;
    out Precision:    smallint;
    out Scale:        smallint;
    out Nullable:     smallint
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLGetDiagRec = function(
    ...
    Handle:          TSQLHandle;
    RecNumber:       smallint;
    SQLstate:        PChar; // pointer to 5 character buffer
    out NativeError: integer;
    MessageText:     IntPtr;
    BufferLength:    smallint;
    out TextLength:  smallint
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  _SQLGetInfoInt = function(
    ConnectionHandle: TSQLHDbc;
    InfoType:         word;
    out InfoValue:    NativeInt;
    BufferLength:     smallint;
    StringLengthPtr:  IntPtr
  ): smallint; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  _SQLGetInfo = function(
    ConnectionHandle: TSQLHDbc;
    InfoType:         word;
    InfoValuePtr:     IntPtr;
    BufferLength:     smallint;
...
type
  ...
  _SQLForeignKeys = function(
    HStmt:            TSQLHStmt;
    szPkCatalogName:  IntPtr;
    cbPkCatalogName:  smallint;
    szPkSchemaName:   IntPtr;
    cbPkSchemaName:   smallint;
    szPkTableName:    IntPtr;
    cbPkTableName:    smallint;
    szFkCatalogName:  IntPtr;
    cbFkCatalogName:  smallint;
    szFkSchemaName:   IntPtr;
    cbFkSchemaName:   smallint;
    szFkTableName:    IntPtr;
...
type
  ...
  TODBCCliAPI = class
  private
    FODBCEnv: TODBCEnvironment;
  public
    // Ansi API
    SQLColAttributeA: _SQLColAttribute;
    SQLColumnsA: _SQLColumns;
    SQLConnectA: _SQLConnect;
    SQLDataSourcesA: _SQLDataSources;
    SQLDescribeColA: _SQLDescribeCol;
    SQLDriverConnectA: _SQLDriverConnect;
    SQLDriversA: _SQLDrivers;
    SQLExecDirectA: _SQLExecDirect;
    SQLGetConnectAttrA: _SQLGetConnectAttr;
    SQLGetCursorNameA: _SQLGetCursorName;
    SQLGetDescFieldA: _SQLGetDescField;
    SQLGetDiagFieldA: _SQLGetDiagField;
    SQLGetDiagRecA: _SQLGetDiagRec;
    SQLGetInfoA: _SQLGetInfo;
    SQLGetStmtAttrA: _SQLGetStmtAttr;
    SQLPrepareA: _SQLPrepare;
    SQLProcedureColumnsA: _SQLProcedureColumns;
    SQLProceduresA: _SQLProcedures;
    SQLSetConnectAttrA: _SQLSetConnectAttr;
    SQLSetCursorNameA: _SQLSetCursorName;
    SQLSetDescFieldA: _SQLSetDescField;
    SQLSetStmtAttrA: _SQLSetStmtAttr;
    SQLSpecialColumnsA: _SQLSpecialColumns;
    SQLStatisticsA: _SQLStatistics;
    SQLTablesA: _SQLTables;
    SQLPrimaryKeysA: _SQLPrimaryKeys;
    SQLForeignKeysA: _SQLForeignKeys;
    SQLColumnPrivilegesA: _SQLColumnPrivileges;
    SQLTablePrivilegesA: _SQLTablePrivileges;
    // Wide API
    SQLColAttributeW: _SQLColAttribute;
    SQLColumnsW: _SQLColumns;
    SQLConnectW: _SQLConnect;
    SQLDataSourcesW: _SQLDataSources;
    SQLDescribeColW: _SQLDescribeCol;
    SQLDriverConnectW: _SQLDriverConnect;
    SQLDriversW: _SQLDrivers;
    SQLExecDirectW: _SQLExecDirect;
    SQLGetConnectAttrW: _SQLGetConnectAttr;
    SQLGetCursorNameW: _SQLGetCursorName;
    SQLGetDescFieldW: _SQLGetDescField;
    SQLGetDiagFieldW: _SQLGetDiagField;
    SQLGetDiagRecW: _SQLGetDiagRec;
    SQLGetInfoW: _SQLGetInfo;
    SQLGetStmtAttrW: _SQLGetStmtAttr;
    SQLPrepareW: _SQLPrepare;
    SQLProcedureColumnsW: _SQLProcedureColumns;
    SQLProceduresW: _SQLProcedures;
    SQLSetConnectAttrW: _SQLSetConnectAttr;
    SQLSetCursorNameW: _SQLSetCursorName;
    SQLSetDescFieldW: _SQLSetDescField;
    SQLSetStmtAttrW: _SQLSetStmtAttr;
    SQLSpecialColumnsW: _SQLSpecialColumns;
    SQLStatisticsW: _SQLStatistics;
    SQLTablesW: _SQLTables;
    SQLPrimaryKeysW: _SQLPrimaryKeys;
    SQLForeignKeysW: _SQLForeignKeys;
    SQLColumnPrivilegesW: _SQLColumnPrivileges;
    SQLTablePrivilegesW: _SQLTablePrivileges;
    // Common API
    ...
    SQLGetTypeInfo: _SQLGetTypeInfo;
    ...
    SQLSetPos: _SQLSetPos;
    SQLBulkOperations: _SQLBulkOperations;
    SQLSetStmtAttrPtr: _SQLSetStmtAttrPtr;
    SQLSetStmtAttrInt: _SQLSetStmtAttrInt;

    constructor Create(ODBCEnv: TODBCEnvironment);

    function SQLHEnv: TSQLHEnv;
    function GetODBCError(HandleType: smallint; Handle: TSQLHandle; ErrorCode: smallint): EODBCError;
  end;

  IODBCEnvironment = interface
  ['{ED765316-A34C-47BF-BEF0-FA53FCB968F4}']
  ...
  {$ENDIF}
    ...
    function CreateAPI: TODBCCliAPI; virtual;
    procedure InitAPI(IsUnicode: Boolean); virtual;
  public
    constructor Create;
  ...
  function GetODBCEnvironment: IODBCEnvironment;
  function IsODBCError(ReturnCode: smallint): boolean;
  function FromODBCString(P: IntPtr): string; overload;
{$IFNDEF USE_UNICODE_DRIVER}
  function ToODBCString(const Value: string): AnsiString; {$IFDEF USE_INLINE}inline;{$ENDIF}
{$ENDIF}

implementation

var
  ODBCEnv: TODBCEnvironment;
  LockODBCEnv: TCriticalSection;
...
begin
  ...
  try
    if ODBCEnv = nil then
      ODBCEnv := TODBCEnvironment.Create;
    Result := ODBCEnv as IODBCEnvironment;
  finally
    LockODBCEnv.Leave;
  end;
end;
...
function FromODBCString(P: IntPtr): string;
begin
{$IFDEF USE_UNICODE_DRIVER}
  Result := Marshal.PtrToStringUni(P);
{$ELSE}
  {$IFDEF IS_UNICODE}
  Result := Utf8Decode(Marshal.PtrToStringAnsi(P));
  {$ELSE}
  Result := Marshal.PtrToStringAnsi(P);
  {$IFDEF MSWINDOWS}{$IFDEF FPC}
  Result := CRFunctions.AnsiToUtf8(Result);
  {$ENDIF}{$ENDIF}
  {$ENDIF}
{$ENDIF}
end;
...
{$ELSE}{$IFDEF FPC}
  {$IFDEF MSWINDOWS}
  Result := CRFunctions.Utf8ToAnsi(Value);
  {$ELSE}
  Result := Value;
  {$ENDIF}
{$ELSE}
...
constructor TODBCCliAPI.Create(ODBCEnv: TODBCEnvironment);
begin
  inherited Create;
...
function TODBCCliAPI.SQLHEnv: TSQLHEnv;
begin
  Result := FODBCEnv.SQLHEnv;
end;

function TODBCCliAPI.GetODBCError(HandleType: smallint; Handle: TSQLHandle;
  ErrorCode: smallint): EODBCError;
const
  // bug with 8192 buffer size in SQL Anywhere with UTF-8 encoding
  // 8192 * 4 = 32768 for SmallInt it is negative value
  BufSize = 8190;
var
  Buf: IntPtr;
  State: TSQLState;
  ...
  Msg: string;
begin
  FillChar(State[0], 5 * SizeOf(Char), 0);
  NativeError := 0;
  Buf := Marshal.AllocHGlobal(BufSize * ODBCCharSize);
  try
  {$IFDEF USE_UNICODE_DRIVER}
    Res := SQLGetDiagRecW(HandleType, Handle, 1, State, NativeError, Buf, BufSize, Len);
  {$ELSE}
    Res := SQLGetDiagRecA(HandleType, Handle, 1, State, NativeError, Buf, BufSize, Len);
  {$ENDIF}
    if not IsODBCError(Res) then
      Msg := FromODBCString(Buf)
    else begin
    {$IFDEF USE_UNICODE_DRIVER}
      Res := SQLGetDiagRecW(SQL_HANDLE_ENV, SQLHEnv, 1, State, NativeError, Buf, BufSize, Len);
    {$ELSE}
      Res := SQLGetDiagRecA(SQL_HANDLE_ENV, SQLHEnv, 1, State, NativeError, Buf, BufSize, Len);
    {$ENDIF}
      if not IsODBCError(Res) then
        Msg := FromODBCString(Buf);
    end;
...
begin
  ...
  // FCLi mist be destroyed in FreeLib
  FreeLib;
...
procedure TODBCEnvironment.LoadLib;
begin
  FLock.Enter;
  try
    if NativeUInt(FLib) <> 0 then
      exit;

  {$IFDEF MSWINDOWS}
    FLib := LoadLibraryEx(PChar(ODBCDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
  {$ENDIF}
  {$IFDEF POSIX}
    FLib := dlopen(PAnsiChar(AnsiString(ODBCDLL)), RTLD_LAZY);
  {$ENDIF}
  {$IFDEF UNIX}
    FLib := dlopen(PChar(ODBCDLL), RTLD_LAZY);
  {$ENDIF}

    if NativeUInt(FLib) = 0 then
      raise Exception.Create('Cannot load client library: ' + ODBCDLL);
...
procedure TODBCEnvironment.FreeLib;
begin
  FLock.Enter;
  try
    if NativeUInt(FLib) = 0 then
...
function TODBCEnvironment.IsLoaded: boolean;
begin
  Result := NativeUInt(FLib) <> 0;
end;
...
function TODBCEnvironment.GetProc(const Name: string): IntPtr;
begin
{$IFDEF MSWINDOWS}
  Result := GetProcAddress(FLib, PChar(Name));
{$ENDIF}
{$IFDEF POSIX}
  Result := dlsym(FLib, PAnsiChar(AnsiString(Name)));
{$ENDIF}
{$IFDEF UNIX}
...
function TODBCEnvironment.CreateAPI: TODBCCliAPI;
begin
  Result := TODBCCliAPI.Create(self);
end;

procedure TODBCEnvironment.InitAPI(IsUnicode: Boolean);
begin
  if FCli <> nil then
    Exit;
  ...
  try
    if IsUnicode then begin
      FCli.SQLColAttributeW := GetProc('SQLColAttributeW');
      FCli.SQLColumnsW := GetProc('SQLColumnsW');
      FCli.SQLConnectW := GetProc('SQLConnectW');
      FCli.SQLDataSourcesW := GetProc('SQLDataSourcesW');
      FCli.SQLDescribeColW := GetProc('SQLDescribeColW');
      FCli.SQLDriverConnectW := GetProc('SQLDriverConnectW');
      FCli.SQLDriversW := GetProc('SQLDriversW');
      FCli.SQLExecDirectW := GetProc('SQLExecDirectW');
      FCli.SQLGetConnectAttrW := GetProc('SQLGetConnectAttrW');
      FCli.SQLGetCursorNameW := GetProc('SQLGetCursorNameW');
      FCli.SQLGetDescFieldW := GetProc('SQLGetDescFieldW');
      FCli.SQLGetDiagFieldW := GetProc('SQLGetDiagFieldW');
      FCli.SQLGetDiagRecW := GetProc('SQLGetDiagRecW');
      FCli.SQLGetInfoW := GetProc('SQLGetInfoW');
      FCli.SQLGetStmtAttrW := GetProc('SQLGetStmtAttr');
      FCli.SQLPrepareW := GetProc('SQLPrepareW');
      FCli.SQLProcedureColumnsW := GetProc('SQLProcedureColumnsW');
      FCli.SQLProceduresW := GetProc('SQLProceduresW');
      FCli.SQLSetConnectAttrW := GetProc('SQLSetConnectAttrW');
      FCli.SQLSetCursorNameW := GetProc('SQLSetCursorNameW');
      FCli.SQLSetDescFieldW := GetProc('SQLSetDescFieldW');
      FCli.SQLSetStmtAttrW := GetProc('SQLSetStmtAttrW');
      FCli.SQLSpecialColumnsW := GetProc('SQLSpecialColumnsW');
      FCli.SQLStatisticsW := GetProc('SQLStatisticsW');
      FCli.SQLTablesW := GetProc('SQLTablesW');
      FCli.SQLPrimaryKeysW := GetProc('SQLPrimaryKeysW');
      FCli.SQLForeignKeysW := GetProc('SQLForeignKeysW');
      FCli.SQLColumnPrivilegesW := GetProc('SQLColumnPrivilegesW');
      FCli.SQLTablePrivilegesW := GetProc('SQLTablePrivilegesW');

      FCli.SQLColAttributeA := nil;
      FCli.SQLColumnsA := nil;
      FCli.SQLConnectA := nil;
      FCli.SQLDataSourcesA := nil;
      FCli.SQLDescribeColA := nil;
      FCli.SQLDriverConnectA := nil;
      FCli.SQLDriversA := nil;
      FCli.SQLExecDirectA := nil;
      FCli.SQLGetConnectAttrA := nil;
      FCli.SQLGetCursorNameA := nil;
      FCli.SQLGetDescFieldA := nil;
      FCli.SQLGetDiagFieldA := nil;
      FCli.SQLGetDiagRecA := nil;
      FCli.SQLGetInfoA := nil;
      FCli.SQLGetStmtAttrA := nil;
      FCli.SQLPrepareA := nil;
      FCli.SQLProcedureColumnsA := nil;
      FCli.SQLProceduresA := nil;
      FCli.SQLSetConnectAttrA := nil;
      FCli.SQLSetCursorNameA := nil;
      FCli.SQLSetDescFieldA := nil;
      FCli.SQLSetStmtAttrA := nil;
      FCli.SQLSpecialColumnsA := nil;
      FCli.SQLStatisticsA := nil;
      FCli.SQLTablesA := nil;
      FCli.SQLPrimaryKeysA := nil;
      FCli.SQLForeignKeysA := nil;
      FCli.SQLColumnPrivilegesA := nil;
      FCli.SQLTablePrivilegesA := nil;

      FCli.SQLColAttributeInt := @FCli.SQLColAttributeW;
      FCli.SQLGetConnectAttrInt := @FCli.SQLGetConnectAttrW;
      FCli.SQLGetDescFieldInt := @FCli.SQLGetDescFieldW;
      FCli.SQLGetDescFieldPtr := @FCli.SQLGetDescFieldW;
      FCli.SQLGetInfoInt := @FCli.SQLGetInfoW;
      FCli.SQLGetStmtAttrPtr := @FCli.SQLGetStmtAttrW;
      FCli.SQLSetConnectAttrInt := @FCli.SQLSetConnectAttrW;
      FCli.SQLSetDescFieldInt := @FCli.SQLSetDescFieldW;
      FCli.SQLSetDescFieldPtr := @FCli.SQLSetDescFieldW;
      FCli.SQLSetStmtAttrInt := @FCli.SQLSetStmtAttrW;
      FCli.SQLSetStmtAttrPtr := @FCli.SQLSetStmtAttrW;
    end
    else begin
      FCli.SQLColAttributeA := GetProc('SQLColAttribute');
      FCli.SQLColumnsA := GetProc('SQLColumns');
      FCli.SQLConnectA := GetProc('SQLConnect');
      FCli.SQLDataSourcesA := GetProc('SQLDataSources');
      FCli.SQLDescribeColA := GetProc('SQLDescribeCol');
      FCli.SQLDriverConnectA := GetProc('SQLDriverConnect');
      FCli.SQLDriversA := GetProc('SQLDrivers');
      FCli.SQLExecDirectA := GetProc('SQLExecDirect');
      FCli.SQLGetConnectAttrA := GetProc('SQLGetConnectAttr');
      FCli.SQLGetCursorNameA := GetProc('SQLGetCursorName');
      FCli.SQLGetDescFieldA := GetProc('SQLGetDescField');
      FCli.SQLGetDiagFieldA := GetProc('SQLGetDiagField');
      FCli.SQLGetDiagRecA := GetProc('SQLGetDiagRec');
      FCli.SQLGetInfoA := GetProc('SQLGetInfo');
      FCli.SQLGetStmtAttrA := GetProc('SQLGetStmtAttr');
      FCli.SQLPrepareA := GetProc('SQLPrepare');
      FCli.SQLProcedureColumnsA := GetProc('SQLProcedureColumns');
      FCli.SQLProceduresA := GetProc('SQLProcedures');
      FCli.SQLSetCursorNameA := GetProc('SQLSetCursorName');
      FCli.SQLSetConnectAttrA := GetProc('SQLSetConnectAttr');
      FCli.SQLSetDescFieldA := GetProc('SQLSetDescField');
      FCli.SQLSetStmtAttrA := GetProc('SQLSetStmtAttr');
      FCli.SQLSpecialColumnsA := GetProc('SQLSpecialColumns');
      FCli.SQLStatisticsA := GetProc('SQLStatistics');
      FCli.SQLTablesA := GetProc('SQLTables');
      FCli.SQLPrimaryKeysA := GetProc('SQLPrimaryKeys');
      FCli.SQLForeignKeysA := GetProc('SQLForeignKeys');
      FCli.SQLColumnPrivilegesA := GetProc('SQLColumnPrivileges');
      FCli.SQLTablePrivilegesA := GetProc('SQLTablePrivileges');

      FCli.SQLColAttributeW := nil;
      FCli.SQLColumnsW := nil;
      FCli.SQLConnectW := nil;
      FCli.SQLDataSourcesW := nil;
      FCli.SQLDescribeColW := nil;
      FCli.SQLDriverConnectW := nil;
      FCli.SQLDriversW := nil;
      FCli.SQLExecDirectW := nil;
      FCli.SQLGetConnectAttrW := nil;
      FCli.SQLGetCursorNameW := nil;
      FCli.SQLGetDescFieldW := nil;
      FCli.SQLGetDiagFieldW := nil;
      FCli.SQLGetDiagRecW := nil;
      FCli.SQLGetInfoW := nil;
      FCli.SQLGetStmtAttrW := nil;
      FCli.SQLPrepareW := nil;
      FCli.SQLProcedureColumnsW := nil;
      FCli.SQLProceduresW := nil;
      FCli.SQLSetConnectAttrW := nil;
      FCli.SQLSetCursorNameW := nil;
      FCli.SQLSetDescFieldW := nil;
      FCli.SQLSetStmtAttrW := nil;
      FCli.SQLSpecialColumnsW := nil;
      FCli.SQLStatisticsW := nil;
      FCli.SQLTablesW := nil;
      FCli.SQLPrimaryKeysW := nil;
      FCli.SQLForeignKeysW := nil;
      FCli.SQLColumnPrivilegesW := nil;
      FCli.SQLTablePrivilegesW := nil;

      FCli.SQLColAttributeInt := @FCli.SQLColAttributeA;
      FCli.SQLGetConnectAttrInt := @FCli.SQLGetConnectAttrA;
      FCli.SQLGetDescFieldInt := @FCli.SQLGetDescFieldA;
      FCli.SQLGetDescFieldPtr := @FCli.SQLGetDescFieldA;
      FCli.SQLGetInfoInt := @FCli.SQLGetInfoA;
      FCli.SQLGetStmtAttrPtr := @FCli.SQLGetStmtAttrA;
      FCli.SQLSetConnectAttrInt := @FCli.SQLSetConnectAttrA;
      FCli.SQLSetDescFieldInt := @FCli.SQLSetDescFieldA;
      FCli.SQLSetDescFieldPtr := @FCli.SQLSetDescFieldA;
      FCli.SQLSetStmtAttrInt := @FCli.SQLSetStmtAttrA;
      FCli.SQLSetStmtAttrPtr := @FCli.SQLSetStmtAttrA;
    end;
  except
    FCli.Free;
    raise;
  ...
  FCli.SQLAllocHandle := GetProc('SQLAllocHandle');
  FCli.SQLBindCol := GetProc('SQLBindCol');
  FCli.SQLBindParameter := GetProc('SQLBindParameter');
  FCli.SQLCloseCursor := GetProc('SQLCloseCursor');
  FCli.SQLDisconnect := GetProc('SQLDisconnect');
  FCli.SQLEndTran := GetProc('SQLEndTran');
  FCli.SQLExecute := GetProc('SQLExecute');
  FCli.SQLFetch := GetProc('SQLFetch');
  FCli.SQLFetchScroll := GetProc('SQLFetchScroll');
  FCli.SQLFreeHandle := GetProc('SQLFreeHandle');
  FCli.SQLFreeStmt := GetProc('SQLFreeStmt');
  FCli.SQLGetData := GetProc('SQLGetData');
  FCli.SQLGetEnvAttrInt := GetProc('SQLGetEnvAttr');
  FCli.SQLMoreResults := GetProc('SQLMoreResults');
  FCli.SQLNumResultCols := GetProc('SQLNumResultCols');
  FCli.SQLGetTypeInfo := GetProc('SQLGetTypeInfo');
  FCli.SQLParamData := GetProc('SQLParamData');
  FCli.SQLPutData := GetProc('SQLPutData');
  FCli.SQLRowCount := GetProc('SQLRowCount');
  FCli.SQLSetEnvAttrInt := GetProc('SQLSetEnvAttr');
  FCli.SQLSetPos := GetProc('SQLSetPos');
  FCli.SQLBulkOperations := GetProc('SQLBulkOperations');
end;

procedure TODBCEnvironment.InitEnvironment;
...
begin
  ...
  try
    ...
    Res := Cli.SQLAllocHandle(SQL_HANDLE_ENV, nil, FSQLHEnv);
    if IsODBCError(Res) then
      Error(Res);

    try
      Res := Cli.SQLSetEnvAttrInt(FSQLHEnv, SQL_ATTR_ODBC_VERSION, SQL_OV_ODBC3, 0);
      if IsODBCError(Res) then
        Error(Res);
    except
      FreeEnvironment;
...
procedure TODBCEnvironment.FreeEnvironment;
begin
  FLock.Enter;
  try
    if SQLHEnv = nil then
    ...
    Cli.SQLFreeHandle(SQL_HANDLE_ENV, FSQLHEnv);
...
function TODBCEnvironment.IsInited: boolean;
begin
  Result := SQLHEnv <> nil;
end;

function TODBCEnvironment.SQLHEnv: TSQLHEnv;
begin
  Result := FSQLHEnv;
end;

function TODBCEnvironment.Cli: TODBCCliAPI;
begin
  Result := FCli;
end;
...
initialization
  ODBCDLL := ODBCDLLName;
  LockODBCEnv := TCriticalSection.Create;
  ODBCEnv := nil;
