...
const
  SizeOf_DBProp = SizeOf(DBProp); // 52 72
...
// *********************************************************************//
  {$EXTERNALSYM ISSCommandWithParameters}
  {$HPPEMIT '__interface ISSCommandWithParameters;'}
  {$HPPEMIT 'typedef System::DelphiInterface<ISSCommandWithParameters> _di_ISSCommandWithParameters;'}
