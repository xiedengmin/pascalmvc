...
const
  SizeOf_OleVariant = SizeOf(OleVariant);
...
type
  DBCOLUMNFLAGS = {$IFDEF MSWINDOWS}UINT;{$ELSE}Cardinal;{$ENDIF MSWINDOWS}
...
// @@@- V2.1
  ...
  DB_E_CATASTROPHICFAILURE             = HResult($8000FFFF);
  {$EXTERNALSYM DB_E_CATASTROPHICFAILURE}
...
const
  ...
  SSPROP_INIT_APPLICATIONINTENT = 24; // MS SQL Server 2012 specific
  SSPROP_INIT_MULTISUBNETFAILOVER = 25; // This property is only available with the MSOLEDBSQL provider
