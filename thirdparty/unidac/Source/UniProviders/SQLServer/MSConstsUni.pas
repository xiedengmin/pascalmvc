...
// default connection property values
  DefValEncrypt = False;
  DefValPersistSecurityInfo = False;
  DefValAutoTranslate = True;
  DefValMultipleActiveResultSets = False;
  DefValMultipleConnections = True;
  DefValTrustServerCertificate = False;
  DefValMultiSubnetFailover = False;

resourcestring
  SOLEDBError             = 'OLE DB error occurred. Code %Xh';
  ...
  SSFAndServerCursors     = 'The SmartFetch mode not allowed for server cursors';
  ...
  SConnectionClosed          = 'Cannot perform operation on closed connection';
  ...
  SSQLOLEDBProviderName      = 'Microsoft OLE DB Provider for SQL Server';
  SProviderSQLOLEDB          = 'SQLOLEDB.1';
  SProviderMSOLEDBSQL        = 'MSOLEDBSQL.1';
  SProviderNativeClient      = 'SQLNCLI.1';
  SProviderNativeClient10    = 'SQLNCLI10.1';
  SProviderNativeClient11    = 'SQLNCLI11.1';
  ...
  SDirectModeNotSupported     = 'Direct mode is not supported';
  SOnlyDirectModeSupported    = 'Only Direct mode is supported';
  SPropertyNotImplemented     = 'Property %s is not implemented';
