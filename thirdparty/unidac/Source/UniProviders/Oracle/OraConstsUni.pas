...
// default connection property values
  DefValOraConnectionTimeout = 0;
  DefValDirect = False;

resourcestring
  SDirectModeNotSupported = 'Direct Mode is not supported';
  SOciModeNotAvailable    = 'OCI Mode is not available on iOS and Android. You should set the Direct connection option to True.';
  SSessionNotDefined      = 'Session is not defined';
  SSessionNotConnected    = 'Session is not connected';
  SSessionOpen            = 'Cannot perform this operation on an open connection';
...
//  SUpdateFailed           = 'Update Failed. Found %d records';
  ...
  SCannotConvertNumberToBCD = 'Cannot convert to Number to BCD';
