...
{$ENDIF}
  ...
  CLRClasses, CRTypes, CRFunctions, MemUtils, DAConsts,
{$IFNDEF UNIDACPRO}
  IBCConsts;
{$ELSE}
  IBCConstsUni;
...
type
  ...
  TClientVersion = packed record
    IsFirebird: boolean;
    PlatformCode: string;
    Distribution: Char;
    VersionStr: string;
    Version: Currency;
    Major, Minor, MinorMinor, Build: integer;
  end;
...
{ InterBase Handle Definitions }
  ...
  TISC_CALLBACK                 = procedure(P: IntPtr; Length: SmallInt; Updated: IntPtr); cdecl;
...
const
  SizeOfXSQLVAR_V1 = SizeOf(TXSQLVAR_V1);
  OffsetOf_XSQLVAR_V1_sqltype = 0;
  OffsetOf_XSQLVAR_V1_sqlscale =                //2(32bit)   //2(64bit)
    OffsetOf_XSQLVAR_V1_sqltype + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_sqlsubtype =              //4(32bit)   //4(64bit)
    OffsetOf_XSQLVAR_V1_sqlscale + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_sqllen =                  //6(32bit)   //6(64bit)
    OffsetOf_XSQLVAR_V1_sqlsubtype + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_sqldata =                 //8(32bit)   //8(64bit)
    OffsetOf_XSQLVAR_V1_sqllen + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_sqlind =                  //12(32bit)  //16(64bit)
    OffsetOf_XSQLVAR_V1_sqldata + SizeOf_IntPtr;
  OffsetOf_XSQLVAR_V1_sqlname_length =          //16(32bit)  //24(64bit)
    OffsetOf_XSQLVAR_V1_sqlind + SizeOf_IntPtr;
  OffsetOf_XSQLVAR_V1_sqlname =                 //18(32bit)  //26(64bit)
    OffsetOf_XSQLVAR_V1_sqlname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_relname_length =          //50(32bit)  //58(64bit)
    OffsetOf_XSQLVAR_V1_sqlname + 32;
  OffsetOf_XSQLVAR_V1_relname =                 //52(32bit)  //60(64bit)
    OffsetOf_XSQLVAR_V1_relname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_ownname_length =          //84(32bit)  //92(64bit)
    OffsetOf_XSQLVAR_V1_relname + 32;
  OffsetOf_XSQLVAR_V1_ownname =                 //86(32bit)  //94(64bit)
    OffsetOf_XSQLVAR_V1_ownname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_V1_aliasname_length =        //118(32bit) //126(64bit)
    OffsetOf_XSQLVAR_V1_ownname + 32;
  OffsetOf_XSQLVAR_V1_aliasname =               //120(32bit) //128(64bit)
    OffsetOf_XSQLVAR_V1_aliasname_length + SizeOf(Short);
...
const
  SizeOfXSQLDA_V1 = SizeOf(TXSQLDA_V1);
...
const
  SizeOfXSQLVAR = SizeOf(TXSQLVAR);
  OffsetOf_XSQLVAR_sqltype = 0;
  OffsetOf_XSQLVAR_sqlscale =                 //2(32bit)   //2(64bit)
    OffsetOf_XSQLVAR_sqltype + SizeOf(Short);
  OffsetOf_XSQLVAR_sqlprecision =             //4(32bit)   //4(64bit)
    OffsetOf_XSQLVAR_sqlscale + SizeOf(Short);
  OffsetOf_XSQLVAR_sqlsubtype =               //6(32bit)   //6(64bit)
    OffsetOf_XSQLVAR_sqlprecision + SizeOf(Short);
  OffsetOf_XSQLVAR_sqllen =                   //8(32bit)   //8(64bit)
    OffsetOf_XSQLVAR_sqlsubtype + SizeOf(Short);
  OffsetOf_XSQLVAR_sqldata =                  //12(32bit)  //16(64bit)
    OffsetOf_XSQLVAR_sqllen {+ SizeOf(Short)} + SizeOf_IntPtr; // Should be 10, but Marshal.OffsetOf return 12(16)
  OffsetOf_XSQLVAR_sqlind =                   //16(32bit)  //24(64bit)
    OffsetOf_XSQLVAR_sqldata + SizeOf_IntPtr;
  OffsetOf_XSQLVAR_sqlname_length =           //20(32bit)  //32(64bit)
    OffsetOf_XSQLVAR_sqlind + SizeOf_IntPtr;
  OffsetOf_XSQLVAR_sqlname =                  //22(32bit)  //34(64bit)
    OffsetOf_XSQLVAR_sqlname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_relname_length =           //90(32bit)  //102(64bit)
    OffsetOf_XSQLVAR_sqlname + METADATALENGTH;
  OffsetOf_XSQLVAR_relname =                  //92(32bit)  //104(64bit)
    OffsetOf_XSQLVAR_relname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_ownname_length =           //160(32bit) //172(64bit)
    OffsetOf_XSQLVAR_relname + METADATALENGTH;
  OffsetOf_XSQLVAR_ownname =                  //162(32bit) //174(64bit)
    OffsetOf_XSQLVAR_ownname_length + SizeOf(Short);
  OffsetOf_XSQLVAR_aliasname_length =         //230(32bit) //242(64bit)
    OffsetOf_XSQLVAR_ownname + METADATALENGTH;
  OffsetOf_XSQLVAR_aliasname =                //232(32bit) //244(64bit)
    OffsetOf_XSQLVAR_aliasname_length + SizeOf(Short);
...
const
  SizeOfXSQLDA = SizeOf(TXSQLDA);
  OffsetOf_XSQLDA_version = 0;
  OffsetOf_XSQLDA_sqldaid =                  //2(32bit)   //2(64bit)
    OffsetOf_XSQLDA_version + SizeOf(Short);
  OffsetOf_XSQLDA_sqldabc =                  //12(32bit)  //12(64bit)
    OffsetOf_XSQLDA_sqldaid + 8 + 2; // Should be 10, but Marshal.OffsetOf return 12
  OffsetOf_XSQLDA_sqln =                     //16(32bit)  //16(64bit)
    OffsetOf_XSQLDA_sqldabc + SizeOf(ISC_LONG);
  OffsetOf_XSQLDA_sqld =                     //18(32bit)   //18(64bit)
    OffsetOf_XSQLDA_sqln + SizeOf(Short);
  OffsetOf_XSQLDA_sqlvar =                   //20(32bit)   //24(64bit)
    SizeOfXSQLDA - SizeOfXSQLVAR;
...
const
  SizeOfISC_TEB = SizeOf(TISC_TEB);
  OffsetOf_TISC_TEB_db_handle = 0;
  OffsetOf_TISC_TEB_tpb_length = OffsetOf_TISC_TEB_db_handle + SizeOf_IntPtr;
...
const
  SizeOfBLOB_DESC = SizeOf(TISC_BLOB_DESC);
...
const
  SizeOfISC_ARRAY_BOUND = SizeOf(TISC_ARRAY_BOUND);
...
const
  SizeOfISC_ARRAY_DESC = SizeOf(TISC_ARRAY_DESC);
...
const
  SizeOfISC_ARRAY_DESC_V2 = SizeOf(TISC_ARRAY_DESC_V2);
...
{ GDS functions definitions }
  ...
  Tisc_attach_database = function (status_vector: PISC_STATUS; db_name_length: Short;
                             ...
                             parm_buffer_length: Short; parm_buffer: {$IFDEF FPC}PChar{$ELSE}TBytes{$ENDIF}): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_array_gen_sdl = function(status_vector: PISC_STATUS;
                            isc_array_desc: IntPtr;
                            isc_arg3: PShort;
                            isc_arg4: IntPtr;
                            isc_arg5: PShort): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_array_lookup_bounds = function (status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                 ...
                                 descriptor: IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_blob_default_desc2 = procedure (descriptor: PISC_BLOB_DESC_V2; table_name: PUChar; column_name: PUChar); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_blob_gen_bpb = function (status_vector: PISC_STATUS; to_descriptor, from_descriptor: PISC_BLOB_DESC;
                          ...
                          bpb_length: PUShort): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_blob_info = function (status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                       ...
                       result_buffer_length: Short; result_buffer: IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_blob_lookup_desc = function (status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                              ...
                              descriptor: PISC_BLOB_DESC; global: PUChar): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_blob_lookup_desc2 = function (status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                               trans_handle: PISC_TR_HANDLE; table_name, column_name: IntPtr;
                               descriptor: PISC_BLOB_DESC_v2; global: PUChar): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_blob_set_desc = function (status_vector: PISC_STATUS; table_name, column_name: IntPtr;
                           subtype, charset, segment_size: Short; descriptor: PISC_BLOB_DESC): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_blob_set_desc2 = function (status_vector: PISC_STATUS; table_name, column_name: IntPtr;
                            subtype, charset, segment_size: Short;
                            descriptor: PISC_BLOB_DESC_V2): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_cancel_events = function (status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                           event_id: PISC_LONG): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_create_blob2 = function (status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                          ...
                          blob_id : PISC_QUAD; bpb_length : Short; bpb_address : {$IFDEF FPC}PChar{$ELSE}TBytes{$ENDIF}): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_decode_date = procedure (ib_date: PISC_QUAD;var tm_date: TCTimeStructure); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_decode_sql_date = procedure (ib_date: PISC_DATE;var tm_date: TCTimeStructure); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_decode_sql_time = procedure (ib_time: PISC_TIME;var tm_date: TCTimeStructure); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_dsql_execute = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                          ...
                          xsqlda : PXSQLDA): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_dsql_execute2 = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                           stmt_handle : PISC_STMT_HANDLE; dialect : UShort;
                           in_xsqlda, out_xsqlda : PXSQLDA): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_dsql_fetch = function (status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE; dialect : UShort; xsqlda : PXSQLDA): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tfb_cancel_operation = function (status_vector : PISC_STATUS; db_handle: PISC_DB_HANDLE; options : UShort): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
//  https://firebirdsql.org/rlsnotesh/rnfb25-apiods-api.html
//  ISC_STATUS fb_cancel_operation(ISC_STATUS* status_vector, isc_db_handle* db_handle, ISC_USHORT option);


  Tfb_shutdown = function (timeout: UInt; reason: Int): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_dsql_set_cursor_name = function (status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE; cursor_name : IntPtr; _type : UShort): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_dsql_sql_info = function (status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                           ...
                           buffer : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_encode_date = procedure (var tm_date : TCTimeStructure; ib_date : PISC_QUAD); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_encode_sql_date = procedure (var tm_date: TCTimeStructure; ib_date : PISC_DATE); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_encode_sql_time = procedure (var tm_date : TCTimeStructure; ib_time : PISC_TIME); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_seek_blob = function (status_vector : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE;
                       ...
                       offset: ISC_LONG; actual_offset: PISC_LONG): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_interprete = function (buffer : IntPtr; status_vector : PPISC_STATUS): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_open_blob2 = function (status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                        tran_handle: PISC_TR_HANDLE; blob_handle: PISC_BLOB_HANDLE;
                        blob_id: PISC_QUAD; bpb_length: Short; bpb_buffer: {$IFDEF FPC}PChar{$ELSE}TBytes{$ENDIF}): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}


  Tisc_release_savepoint = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE; tran_name : IntPtr) : ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_rollback_savepoint = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE; tran_name : IntPtr; Option : UShort) : ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_start_savepoint = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE; tran_name : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_sqlcode = function (status_vector : PISC_STATUS): ISC_LONG; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_sql_interprete = procedure (sqlcode : Short; buffer : IntPtr; buffer_length : Short); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}


{ Client information functions }

  Tisc_get_client_version = procedure (buffer : IntPtr); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_transaction_info = function (status_vector           : PISC_STATUS;
                              ...
                              result_buffer           : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_dsql_xml_fetch = function (status: PISC_STATUS;
                            stmt: PISC_STMT_HANDLE;
                            da_version: USHORT;
                            sqlda: PXSQLDA;
                            var ib_xmlda: TIB_XMLDA) : Integer; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
...
//                                   {$ENDIF}
  ...
  Tisc_dsql_batch_execute_immed = function (status_vector: IntPtr;
                                    ...
                                    dialect: integer;
                                    number_of_sql: Cardinal;
                                    sql: IntPtr;
                                    rows_affected: IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
...
{ Stream BLOB functions }
  ...
  Tisc_prepare_transaction2 = function (status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE; msg_length : Short; msg : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_put_segment = function (status_vector : PISC_STATUS; blob_handle: PISC_BLOB_HANDLE; seg_buffer_len : UShort; seg_buffer : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_get_segment = function (status_vector : PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                               ...
                               seg_buffer : IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_que_events = function (status_vector : PISC_STATUS; db_handle: PISC_DB_HANDLE;
                              ...
                              event_function : IntPtr; event_function_arg: IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_event_block = function (var event_buffer: IntPtr; var result_buffer: IntPtr; id_count: UShort;
                               ...
                               event_10, event_11, event_12, event_13, event_14, event_15: IntPtr): ISC_LONG; cdecl;

  Tisc_free = function (Buffer: IntPtr): ISC_LONG; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_event_counts = procedure (status_vector: PISC_STATUS; buffer_length: Short; event_buffer: IntPtr; result_buffer: IntPtr); {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
...
//                      {$ENDIF}
  ...
  Tisc_service_attach = function (status_vector: PISC_STATUS;
                                  ...
                                  isc_arg5: UShort;
                                  isc_arg6: {$IFDEF FPC}PChar{$ELSE}TBytes{$ENDIF}): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
  ...
  Tisc_service_query = function (status_vector: PISC_STATUS;
                                 ...
                                 isc_arg8: UShort;
                                 isc_arg9: IntPtr): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

  Tisc_service_start = function (status_vector: PISC_STATUS;
                                 service_handle: PISC_SVC_HANDLE;
                                 recv_handle: PISC_SVC_HANDLE;
                                 isc_arg4: UShort;
                                 isc_arg5: {$IFDEF FPC}PChar{$ELSE}TBytes{$ENDIF}): ISC_STATUS; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}

{ Misc functions }

  Tisc_vax_integer = function (buffer: IntPtr; length: UShort): ISC_LONG; {$IFDEF MSWINDOWS}stdcall;{$ELSE}cdecl;{$ENDIF}
...
{ Service parameter block stuff }
  ...
  isc_spb_config                 =          14;
  isc_spb_last_spb_constant      =          isc_spb_config;
  ...
  isc_spb_config_mapped_to_server                 = 123;
...
{ SQL definitions }
  ...
  SQL_IB_LONG                       =        496;
  SQL_IB_SHORT                      =        500;
  SQL_IB_TIMESTAMP                  =        510;
  SQL_IB_BLOB                       =        520;
  SQL_IB_D_FLOAT                    =        530;
  SQL_IB_ARRAY                      =        540;
  SQL_IB_QUAD                       =        550;
  SQL_IB_TYPE_TIME                  =        560;
  SQL_IB_TYPE_DATE                  =        570;
  SQL_IB_INT64                      =        580;
  SQL_IB_DATE                       =        SQL_IB_TIMESTAMP;
  SQL_IB_BOOLEAN                    =        590;
  SQL_FB_BOOLEAN                    =        32764;
...
{CHARSET ID}
  ...
  CH_UNICODE_FSS                 =        3;
  CH_UTF8                        =        4;
// for the unknown reason the UTF8 charset in InterBase XE has the different ID
  CH_UTF8_IBXE                   =        59;
...
{ fatal error codes }
  ...
  isc_conn_shutdown_err     = 335544856;
  isc_db_shutdown_err       = 335544528;
...
var
  FirebirdDatabaseDetected: Boolean;
...
{$IFDEF WIN64}
  GDSDLLName64 = 'ibclient64.dll';
  IBXMLDLLName64 = 'ibxml64.dll';
{$ENDIF}
...
{$ELSE}
{$IFNDEF IOS}
  GDSDLLName = 'libfbclient.so';
  FBClientDLLName = 'libfbclient.so';
{$ELSE}
{$IFNDEF CPUARM}
  GDSDLLName = 'libibtogo.dylib';
  FBClientDLLName = 'libibtogo.dylib';
{$ENDIF}
{$ENDIF}
{$ENDIF}
{$ENDIF}
...
{$ENDIF}
  LibSTDC = 'stdc++';
{$ELSE}
{$IFDEF IBTOGO_USE_ABI}
  LibSTDC = '';
  LibCPP = 'c++_static';
  LibCPP_ABI = 'c++abi';
{$ELSE}
{$IFDEF VER20P}
  LibSTDC = 'gnustl_static';
{$ELSE}
  LibSTDC = 'stlport_static';
{$ENDIF}
{$ENDIF}
{$ENDIF}

  function _isc_sqlcode(status_vector: PISC_STATUS): ISC_LONG; cdecl;
                        external 'libibtogo.a' name PU + 'isc_sqlcode' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_sql_interprete(sqlcode: Short; buffer: IntPtr; buffer_length: Short);  cdecl;
                                external 'libibtogo.a' name PU + 'isc_sql_interprete' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_interprete(buffer: IntPtr; status_vector: PPISC_STATUS): ISC_STATUS; cdecl;
                           external 'libibtogo.a' name PU + 'isc_interprete' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_info(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                          item_list_buffer_length: Short; item_list_buffer: IntPtr;
                          result_buffer_length: Short; result_buffer: IntPtr): ISC_STATUS; cdecl;
                          external 'libibtogo.a' name PU + 'isc_blob_info' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_open_blob2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                           tran_handle: PISC_TR_HANDLE; blob_handle: PISC_BLOB_HANDLE;
                           blob_id: PISC_QUAD; bpb_length: Short; bpb_buffer: TBytes): ISC_STATUS; cdecl;
                           external 'libibtogo.a' name PU + 'isc_open_blob2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_close_blob(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE): ISC_STATUS; cdecl;
                           external 'libibtogo.a' name PU + 'isc_close_blob' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_seek_blob(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                          mode: Short; offset: ISC_LONG; actual_offset: PISC_LONG): ISC_STATUS; cdecl;
                          external 'libibtogo.a' name PU + 'isc_seek_blob' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_create_blob2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                             tran_handle: PISC_TR_HANDLE; blob_handle: PISC_BLOB_HANDLE;
                             blob_id: PISC_QUAD; bpb_length: Short; bpb_address: TBytes): ISC_STATUS; cdecl;
                             external 'libibtogo.a' name PU + 'isc_create_blob2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_cancel_blob(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE): ISC_STATUS; cdecl;
                            external 'libibtogo.a' name PU + 'isc_cancel_blob' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_get_segment(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                            actual_seg_length: PUShort; seg_buffer_length: UShort;
                            seg_buffer: IntPtr): ISC_STATUS; cdecl;
                            external 'libibtogo.a' name PU + 'isc_get_segment' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_put_segment(status_vector: PISC_STATUS; blob_handle: PISC_BLOB_HANDLE;
                            seg_buffer_len: UShort; seg_buffer: IntPtr): ISC_STATUS; cdecl;
                            external 'libibtogo.a' name PU + 'isc_put_segment' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_blob_default_desc(descriptor: PISC_BLOB_DESC; table_name: PUChar;
                                   column_name : PUChar); cdecl;
                                   external 'libibtogo.a' name PU + 'isc_blob_default_desc' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_gen_bpb(status_vector: PISC_STATUS; to_descriptor, from_descriptor: PISC_BLOB_DESC;
                             bpb_buffer_length: UShort; bpb_buffer: PUChar;
                             bpb_length: PUShort): ISC_STATUS; cdecl;
                             external 'libibtogo.a' name PU + 'isc_blob_gen_bpb' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_lookup_desc(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                 trans_handle: PISC_TR_HANDLE; table_name, column_name: PStr;
                                 descriptor: PISC_BLOB_DESC; global: PUChar): ISC_STATUS; cdecl;
                                 external 'libibtogo.a' name PU + 'isc_blob_lookup_desc' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_set_desc(status_vector: PISC_STATUS; table_name, column_name: IntPtr;
                              subtype, charset, segment_size: Short; descriptor: PISC_BLOB_DESC): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_blob_set_desc' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_decode_date(ib_date: PISC_QUAD; var tm_date: TCTimeStructure); cdecl;
                             external 'libibtogo.a' name PU + 'isc_decode_date' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_encode_date(var tm_date : TCTimeStructure; ib_date : PISC_QUAD); cdecl;
                             external 'libibtogo.a' name PU + 'isc_encode_date' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_free_statement(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                                    options: UShort): ISC_STATUS; cdecl;
                                    external 'libibtogo.a' name PU + 'isc_dsql_free_statement' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_execute2(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                              stmt_handle: PISC_STMT_HANDLE; dialect: UShort;
                              in_xsqlda, out_xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_dsql_execute2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_execute(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                             stmt_handle: PISC_STMT_HANDLE; dialect: UShort;
                             xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                             external 'libibtogo.a' name PU + 'isc_dsql_execute' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_set_cursor_name(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                                     cursor_name: IntPtr; _type: UShort): ISC_STATUS; cdecl;
                                     external 'libibtogo.a' name PU + 'isc_dsql_set_cursor_name' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_fetch(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                           dialect: UShort; xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                           external 'libibtogo.a' name PU + 'isc_dsql_fetch' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_sql_info(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                              item_length: Short; items: IntPtr; buffer_length: Short;
                              buffer: IntPtr): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_dsql_sql_info' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_alloc_statement2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                      stmt_handle: PISC_STMT_HANDLE): ISC_STATUS; cdecl;
                                      external 'libibtogo.a' name PU + 'isc_dsql_alloc_statement2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_prepare(status_vector: PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                             stmt_handle: PISC_STMT_HANDLE; length: UShort;
                             statement: PStr; dialect: UShort;
                             xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                             external 'libibtogo.a' name PU + 'isc_dsql_prepare' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_describe_bind(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                                   dialect: UShort; xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                                   external 'libibtogo.a' name PU + 'isc_dsql_describe_bind' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_describe(status_vector: PISC_STATUS; stmt_handle: PISC_STMT_HANDLE;
                              dialect: UShort; xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_dsql_describe' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_execute_immediate(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                       tran_handle: PISC_TR_HANDLE; length: UShort;
                                       statement: IntPtr; dialect: UShort;
                                       xsqlda: PXSQLDA): ISC_STATUS; cdecl;
                                       external 'libibtogo.a' name PU + 'isc_dsql_execute_immediate' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_drop_database(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_drop_database' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_detach_database(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_detach_database' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_attach_database(status_vector: PISC_STATUS; db_name_length: Short;
                                db_name: IntPtr; db_handle: PISC_DB_HANDLE;
                                parm_buffer_length: Short; parm_buffer: TBytes): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_attach_database' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_database_info(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                              item_list_buffer_length: Short; item_list_buffer: IntPtr;
                              result_buffer_length: Short; result_buffer: IntPtr): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_database_info' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_start_multiple(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                              db_handle_count: Short; teb_vector_address: PISC_TEB): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_start_multiple' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_commit_transaction(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE): ISC_STATUS; cdecl;
                                   external 'libibtogo.a' name PU + 'isc_commit_transaction' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_commit_retaining(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE): ISC_STATUS; cdecl;
                                 external 'libibtogo.a' name PU + 'isc_commit_retaining' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_rollback_transaction(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE): ISC_STATUS; cdecl;
                                     external 'libibtogo.a' name PU + 'isc_rollback_transaction' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_prepare_transaction(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE): ISC_STATUS; cdecl;
                                    external 'libibtogo.a' name PU + 'isc_prepare_transaction' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_prepare_transaction2(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                     msg_length: Short; msg: IntPtr): ISC_STATUS; cdecl;
                                     external 'libibtogo.a' name PU + 'isc_prepare_transaction2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_transaction_info(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                 item_list_buffer_length: Short; item_list_buffer: IntPtr;
                                 result_buffer_length: Short; result_buffer: IntPtr): ISC_STATUS; cdecl;
                                 external 'libibtogo.a' name PU + 'isc_transaction_info' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_que_events(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                           event_id: PISC_LONG; length: Short; event_buffer: IntPtr;
                           event_function: IntPtr; event_function_arg: IntPtr): ISC_STATUS; cdecl;
                           external 'libibtogo.a' name PU + 'isc_que_events' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_event_counts(status_vector: PISC_STATUS; buffer_length: Short;
                              event_buffer: IntPtr; result_buffer: IntPtr); cdecl;
                              external 'libibtogo.a' name PU + 'isc_event_counts' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_cancel_events(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                              event_id: PISC_LONG): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_cancel_events' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_event_block(var event_buffer: IntPtr; var result_buffer: IntPtr; id_count: UShort;
                            event_1, event_2, event_3, event_4, event_5, event_6, event_7, event_8, event_9,
                            event_10, event_11, event_12, event_13, event_14, event_15: IntPtr): ISC_LONG; cdecl;
                            external 'libibtogo.a' name PU + 'isc_event_block' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_free(isc_arg1: IntPtr): ISC_LONG; cdecl;
                     external 'libibtogo.a' name PU + 'isc_free' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_rollback_retaining(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE): ISC_STATUS; cdecl;
                                   external 'libibtogo.a' name PU + 'isc_rollback_retaining' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_decode_sql_date(ib_date: PISC_DATE; var tm_date: TCTimeStructure); cdecl;
                                 external 'libibtogo.a' name PU + 'isc_decode_sql_date' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_decode_sql_time(ib_time: PISC_TIME; var tm_date: TCTimeStructure); cdecl;
                                 external 'libibtogo.a' name PU + 'isc_decode_sql_time' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_encode_sql_date(var tm_date: TCTimeStructure; ib_date: PISC_DATE); cdecl;
                                 external 'libibtogo.a' name PU + 'isc_encode_sql_date' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_encode_sql_time(var tm_date: TCTimeStructure; ib_time: PISC_TIME); cdecl;
                                 external 'libibtogo.a' name PU + 'isc_encode_sql_time' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_get_client_version(buffer: IntPtr); cdecl;
                                    external 'libibtogo.a' name PU + 'isc_get_client_version' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_get_client_major_version: Integer; cdecl;
                                    external 'libibtogo.a' name PU + 'isc_get_client_major_version' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_get_client_minor_version: Integer; cdecl;
                                    external 'libibtogo.a' name PU + 'isc_get_client_minor_version' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_array_gen_sdl2(status_vector: PISC_STATUS; isc_array_desc: PISC_ARRAY_DESC_V2;
                               isc_arg3: PShort; isc_arg4: IntPtr; isc_arg5: PShort): ISC_STATUS; cdecl;
                               external 'libibtogo.a' name PU + 'isc_array_gen_sdl2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_array_get_slice2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                 trans_handle: PISC_TR_HANDLE; array_id: PISC_QUAD;
                                 descriptor: PISC_ARRAY_DESC_V2; dest_array: PVoid; slice_length: PISC_LONG): ISC_STATUS; cdecl;
                                 external 'libibtogo.a' name PU + 'isc_array_get_slice2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_array_lookup_bounds2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                    trans_handle: PISC_TR_HANDLE; table_name, column_name: IntPtr;
                                    descriptor: PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl;
                                    external 'libibtogo.a' name PU + 'isc_array_lookup_bounds' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_array_lookup_desc2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                  trans_handle: PISC_TR_HANDLE; table_name, column_name: IntPtr;
                                  descriptor: PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl;
                                  external 'libibtogo.a' name PU + 'isc_array_lookup_desc' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_array_set_desc2(status_vector: PISC_STATUS; table_name: IntPtr;
                               column_name: IntPtr; sql_dtype, sql_length, sql_dimensions: PShort;
                               descriptor: PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl;
                               external 'libibtogo.a' name PU + 'isc_array_set_desc' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;
  ...
  function _isc_array_put_slice2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                ...
                                slice_length: PISC_LONG): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_array_put_slice' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  procedure _isc_blob_default_desc2(descriptor: PISC_BLOB_DESC_V2; table_name: PUChar;
                                    column_name: PUChar); cdecl;
                                    external 'libibtogo.a' name PU + 'isc_blob_default_desc2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_gen_bpb2(status_vector: PISC_STATUS; to_descriptor, from_descriptor: PISC_BLOB_DESC_V2;
                              bpb_buffer_length: UShort; bpb_buffer: PUChar;
                              bpb_length: PUShort): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_blob_gen_bpb2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_lookup_desc2(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                 trans_handle: PISC_TR_HANDLE; table_name, column_name: IntPtr;
                                 descriptor: PISC_BLOB_DESC_v2; global : PUChar): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_lookup_desc2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_blob_set_desc2(status_vector : PISC_STATUS; table_name, column_name: IntPtr;
                              subtype, charset, segment_size: Short;
                              descriptor: PISC_BLOB_DESC_V2): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_set_desc2' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_release_savepoint(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                  tran_name: IntPtr): ISC_STATUS; cdecl;
                                  external 'libibtogo.a' name PU + 'isc_put_segment' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_rollback_savepoint(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                   tran_name: IntPtr; Option: UShort) : ISC_STATUS; cdecl;
                                   external 'libibtogo.a' name PU + 'isc_rollback_savepoint' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_start_savepoint(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                tran_name: IntPtr): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_start_savepoint' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_batch_execute_immed(status_vector: PISC_STATUS; db_handle: PISC_DB_HANDLE;
                                         tran_handle: PISC_TR_HANDLE; dialect: integer; number_of_sql: Cardinal;
                                         sql: IntPtr; rows_affected: IntPtr) : ISC_STATUS; cdecl;
                                         external 'libibtogo.a' name PU + 'isc_dsql_batch_execute_immed' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_dsql_batch_execute(status_vector: PISC_STATUS; tran_handle: PISC_TR_HANDLE;
                                   stmt_handle: PISC_STMT_HANDLE; dialect: integer;
                                   insqlda: PXSQLDA; no_of_rows: Cardinal;
                                   batch_vars: PXSQLVAR; rows_affected: IntPtr) : ISC_STATUS; cdecl;
                                   external 'libibtogo.a' name PU + 'isc_dsql_batch_execute' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_service_attach (status_vector: PISC_STATUS;
                                isc_arg2: UShort; isc_arg3: IntPtr;
                                service_handle: PISC_SVC_HANDLE;
                                isc_arg5: UShort; isc_arg6: TBytes): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_service_attach' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_service_detach(status_vector: PISC_STATUS; service_handle: PISC_SVC_HANDLE): ISC_STATUS; cdecl;
                               external 'libibtogo.a' name PU + 'isc_service_detach' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_service_query  (status_vector: PISC_STATUS;
                                service_handle: PISC_SVC_HANDLE; recv_handle: PISC_SVC_HANDLE;
                                isc_arg4: UShort; isc_arg5: TBytes;
                                isc_arg6: UShort; isc_arg7: TBytes;
                                isc_arg8: UShort; isc_arg9: IntPtr): ISC_STATUS; cdecl;
                                external 'libibtogo.a' name PU + 'isc_service_query' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_service_start (status_vector: PISC_STATUS; service_handle: PISC_SVC_HANDLE;
                              recv_handle: PISC_SVC_HANDLE;
                              isc_arg4: UShort; isc_arg5: TBytes): ISC_STATUS; cdecl;
                              external 'libibtogo.a' name PU + 'isc_service_start' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

  function _isc_vax_integer (buffer: IntPtr;
                             length: UShort): ISC_LONG; cdecl;
                              external 'libibtogo.a' name PU + 'isc_vax_integer' dependency {$IFDEF VER21P}LibCPP,{$IFDEF IBTOGO_USE_ABI} LibCPP_ABI, {$ENDIF}{$ENDIF}LibSTDC;

{$ENDIF IBTOGO_STATIC}

type
  PNotificationRec = ^TNotificationRec;
  TNotificationRec = record
    Code: Pointer;
    Data: Pointer;
  end;

  TGDSNotificationEvent = procedure of object;
  ...
  {$ENDIF}
    ...
    function GetClientVersion(const ClientVersion: string): TClientVersion;
    procedure InitFunctions;
  {$IFDEF IBTOGO_STATIC}
    procedure InitIBToGoFunctions;
  {$ENDIF}

  public
    GDSDLL: string;
    IBXMLDLL: string;
    IsClientLibraryThreadSafe: boolean;
...
//    isc_dsql_prepare_m: Tisc_dsql_prepare_m;
    ...
    isc_dsql_batch_execute: Tisc_dsql_batch_execute;
...
//    Bopen2 : TBopen2;
    ...
    procedure Busy;
    procedure Release;
    procedure RegisterNotification(const Event: TGDSNotificationEvent);
    procedure UnRegisterNotification(Event: TGDSNotificationEvent);

    procedure GetIBError(ErrorCode: integer; UseUnicode: boolean; var ErrorNumber: integer;
      var StatusVector: TStatusVector; var ErrorMsg: string; var SQLErrorMsg: string);
...
//    function putbx(x: AnsiChar; p: PBSTREAM): Int;
    ...
    property ClientVersion: TClientVersion read FClientVersion;
  end;
  ...
  public
    ...
    function GetGDS(const LibFile: string): TGDS; overload;
  end;

var
  GDSList: TGDSList;
  ThreadSafetyClientLibrary: boolean = True;
  ForceThreadSafety: boolean = False;
  ForceUnloadClientLibrary: boolean = False;
...
const
  CharSetMap: array [0..70] of TCharsetMap = (
  (CharsetID: 0; CharSetName: 'NONE'; CharSetWidth: 1; FBCodePage: CP_ACP; IBCodePage: CP_ACP),
  (CharsetID: 1; CharSetName: 'OCTETS'; CharSetWidth: 1; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 2; CharSetName: 'ASCII'; CharSetWidth: 1; FBCodePage: 20127; IBCodePage: 20127),
  (CharsetID: 3; CharSetName: 'UNICODE_FSS'; CharSetWidth: 3; FBCodePage: CP_UTF8; IBCodePage: CP_UTF8),
  (CharsetID: 4; CharSetName: 'UTF8'; CharSetWidth: 4; FBCodePage: CP_UTF8; IBCodePage: CP_UTF8), //InterBase does not have this charset
  (CharsetID: 5; CharSetName: 'SJIS_0208'; CharSetWidth: 2; FBCodePage: 20932; IBCodePage: 20932),
  (CharsetID: 6; CharSetName: 'EUCJ_0208'; CharSetWidth: 2; FBCodePage: 20932; IBCodePage: 20932),
  (CharsetID: 7; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 8; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_UTF8), //InterBase UNICODE_BE
  (CharsetID: 9; CharSetName: 'DOS737'; CharSetWidth: 1; FBCodePage: 737; IBCodePage: 737),
  (CharsetID: 10; CharSetName: 'DOS437'; CharSetWidth: 1; FBCodePage: 437; IBCodePage: 437),
  (CharsetID: 11; CharSetName: 'DOS850'; CharSetWidth: 1; FBCodePage: 850; IBCodePage: 850),
  (CharsetID: 12; CharSetName: 'DOS865'; CharSetWidth: 1; FBCodePage: 865; IBCodePage: 865),
  (CharsetID: 13; CharSetName: 'DOS860'; CharSetWidth: 1; FBCodePage: 860; IBCodePage: 860),
  (CharsetID: 14; CharSetName: 'DOS863'; CharSetWidth: 1; FBCodePage: 863; IBCodePage: 863),
  (CharsetID: 15; CharSetName: 'DOS775'; CharSetWidth: 1; FBCodePage: 775; IBCodePage: 775),
  (CharsetID: 16; CharSetName: 'DOS858'; CharSetWidth: 1; FBCodePage: 858; IBCodePage: 858),
  (CharsetID: 17; CharSetName: 'DOS862'; CharSetWidth: 1; FBCodePage: 862; IBCodePage: 862),
  (CharsetID: 18; CharSetName: 'DOS864'; CharSetWidth: 1; FBCodePage: 864; IBCodePage: 864),
  (CharsetID: 19; CharSetName: 'NEXT'; CharSetWidth: 1; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 20; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 21; CharSetName: 'ISO8859_1'; CharSetWidth: 1; FBCodePage: 28591; IBCodePage: 28591),
  (CharsetID: 22; CharSetName: 'ISO8859_2'; CharSetWidth: 1; FBCodePage: 28592; IBCodePage: 28592),
  (CharsetID: 23; CharSetName: 'ISO8859_3'; CharSetWidth: 1; FBCodePage: 28593; IBCodePage: 28593),
  (CharsetID: 24; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 25; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 26; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 27; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 28; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 29; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 30; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 31; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 32; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 33; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 34; CharSetName: 'ISO8859_4'; CharSetWidth: 1; FBCodePage: 28594; IBCodePage: 28594),
  (CharsetID: 35; CharSetName: 'ISO8859_5'; CharSetWidth: 1; FBCodePage: 28595; IBCodePage: 28595),
  (CharsetID: 36; CharSetName: 'ISO8859_6'; CharSetWidth: 1; FBCodePage: 28596; IBCodePage: 28596),
  (CharsetID: 37; CharSetName: 'ISO8859_7'; CharSetWidth: 1; FBCodePage: 28597; IBCodePage: 28597),
  (CharsetID: 38; CharSetName: 'ISO8859_8'; CharSetWidth: 1; FBCodePage: 28598; IBCodePage: 28598),
  (CharsetID: 39; CharSetName: 'ISO8859_9'; CharSetWidth: 1; FBCodePage: 28599; IBCodePage: 28605), //InterBase ISO8859_15
  (CharsetID: 40; CharSetName: 'ISO8859_13'; CharSetWidth: 1; FBCodePage: 28603; IBCodePage: 28603),
  (CharsetID: 41; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 42; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 43; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 44; CharSetName: 'KSC_5601'; CharSetWidth: 2; FBCodePage: 949; IBCodePage: 949),
  (CharsetID: 45; CharSetName: 'DOS852'; CharSetWidth: 1; FBCodePage: 852; IBCodePage: 852),
  (CharsetID: 46; CharSetName: 'DOS857'; CharSetWidth: 1; FBCodePage: 857; IBCodePage: 857),
  (CharsetID: 47; CharSetName: 'DOS861'; CharSetWidth: 1; FBCodePage: 861; IBCodePage: 861),
  (CharsetID: 48; CharSetName: 'DOS866'; CharSetWidth: 1; FBCodePage: 866; IBCodePage: 866),
  (CharsetID: 49; CharSetName: 'DOS869'; CharSetWidth: 1; FBCodePage: 869; IBCodePage: 869),
  (CharsetID: 50; CharSetName: 'CYRL'; CharSetWidth: 1; FBCodePage: 1251; IBCodePage: 1251),
  (CharsetID: 51; CharSetName: 'WIN1250'; CharSetWidth: 1; FBCodePage: 1250; IBCodePage: 1250),
  (CharsetID: 52; CharSetName: 'WIN1251'; CharSetWidth: 1; FBCodePage: 1251; IBCodePage: 1251),
  (CharsetID: 53; CharSetName: 'WIN1252'; CharSetWidth: 1; FBCodePage: 1252; IBCodePage: 1252),
  (CharsetID: 54; CharSetName: 'WIN1253'; CharSetWidth: 1; FBCodePage: 1253; IBCodePage: 1253),
  (CharsetID: 55; CharSetName: 'WIN1254'; CharSetWidth: 1; FBCodePage: 1254; IBCodePage: 1254),
  (CharsetID: 56; CharSetName: 'BIG_5'; CharSetWidth: 2; FBCodePage: 950; IBCodePage: 950),
  (CharsetID: 57; CharSetName: 'GB_2312'; CharSetWidth: 2; FBCodePage: 936; IBCodePage: 936),
  (CharsetID: 58; CharSetName: 'WIN1255'; CharSetWidth: 1; FBCodePage: 1255; IBCodePage: 20866), //InterBase KOI8R
  (CharsetID: 59; CharSetName: 'WIN1256'; CharSetWidth: 1; FBCodePage: 1256; IBCodePage: CP_UTF8), //InterBase UTF8
  (CharsetID: 60; CharSetName: 'WIN1257'; CharSetWidth: 1; FBCodePage: 1257; IBCodePage: 1257),
  (CharsetID: 61; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 62; CharSetName: 'Unknown'; CharSetWidth: 0; FBCodePage: CP_NONE; IBCodePage: CP_NONE),
  (CharsetID: 63; CharSetName: 'KOI8R'; CharSetWidth: 1; FBCodePage: 20866; IBCodePage: 20866),
  (CharsetID: 64; CharSetName: 'KOI8U'; CharSetWidth: 1; FBCodePage: 21866; IBCodePage: CP_UTF8), //InterBase UNICODE_LE
  (CharsetID: 65; CharSetName: 'WIN1258'; CharSetWidth: 1; FBCodePage: 1258; IBCodePage: 1258),
  (CharsetID: 66; CharSetName: 'TIS620'; CharSetWidth: 1; FBCodePage: 874; IBCodePage: 874),
  (CharsetID: 67; CharSetName: 'GBK'; CharSetWidth: 2; FBCodePage: 936; IBCodePage: 936),
  (CharsetID: 68; CharSetName: 'CP943C'; CharSetWidth: 2; FBCodePage: 943; IBCodePage: 943),
  (CharsetID: 69; CharSetName: 'GB18030'; CharSetWidth: 4; FBCodePage: 54936; IBCodePage: 54936),
  (CharsetID: 70; CharSetName: 'BASE64 '; CharSetWidth: 1; FBCodePage: CP_NONE; IBCodePage: CP_NONE) //Firebird does not have this charset
);

function CharSetIDToCodePage(CharSetID: integer; var CodePage: word; IsFirebird: boolean): boolean;
...
function Utf8ToAnsi(Source: IntPtr; SrcLen: integer; Dest: IntPtr; DestLen: integer): integer; overload;
function Utf8ToAnsi(Source: IntPtr; SrcLen: integer): AnsiString; overload;
...
function StringToPtrGDS(const S: string; UseUnicode: boolean): PStr;
procedure FreeStringGDS(P: PStr; UseUnicode: boolean);
function PtrToStringGDS(P: IntPtr; UseUnicode: boolean): string; overload;
function PtrToStringGDS(P: IntPtr; Size: integer; UseUnicode: boolean): string; overload;

const
  DACProductName = 'IBDAC';

var
  GDSNotificationSection: TCriticalSection;
...
{$ENDIF}
{$IFDEF ANDROID}
  Posix.Stdlib, Androidapi.IOUtils,
{$ENDIF}
{$IFDEF UNIX}
  Unix, dl,
{$ENDIF}
...
begin
  ...
  try
    for i := 0 to List.Count - 1 do
      TGDS(List[i]){$IFNDEF AUTOREFCOUNT}.Free{$ELSE}.DisposeOf{$ENDIF};
...
begin
  ...
  try
    ...
    for i := 0 to List.Count - 1 do begin
      GDS := TGDS(List[i]);
      if (NormFile = '') or AnsiSameText(GDS.GDSDLL, NormFile) then begin
        Result := GDS;
        exit;
      end;
    end;
...
var
  i: integer;
  NotificationEvent: TGDSNotificationEvent;
  pEvent: PNotificationRec;
begin
  GDSNotificationSection.Enter;
  try
...
begin
{$IFDEF MSWINDOWS}
  if ForceThreadSafety or (ThreadSafetyClientLibrary and not IsClientLibraryThreadSafe) then
...
const
  ClientLibs: array[boolean] of string = (GDSDLLName, FBClientDLLName);
var
  NeedLoadLibrary: boolean;
begin
{$IFDEF IBTOGO_STATIC}
{$IFNDEF ANDROID}
  InitIBToGoFunctions;
  IsClientLibraryThreadSafe := True;
  Exit;
{$ELSE}
  if Pos(UpperCase(FBClientDLLName), UpperCase(GDSDLL)) <= 0 then begin
    InitIBToGoFunctions;
    IsClientLibraryThreadSafe := True;
    Exit;
  end;
...
{$IFDEF MSWINDOWS}
  if GDSDLL = '' then begin
    hIBCLib := 0;
  {$IFDEF WIN64}
    if not FirebirdDatabaseDetected then begin
      GDSDLL := GDSDLLName64;
      hIBCLib := LoadLibraryEx(PChar(GDSDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
    end;
  {$ENDIF}
    if hIBCLib = 0 then begin
      GDSDLL := ClientLibs[FirebirdDatabaseDetected];
      hIBCLib := LoadLibraryEx(PChar(GDSDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
      if hIBCLib = 0 then begin
        GDSDLL := ClientLibs[not FirebirdDatabaseDetected];
        hIBCLib := LoadLibraryEx(PChar(GDSDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
      {$IFDEF WIN64}
        if (hIBCLib = 0) and FirebirdDatabaseDetected then begin
          GDSDLL := GDSDLLName64;
          hIBCLib := LoadLibraryEx(PChar(GDSDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
        end;
      {$ENDIF}
    ...
    NeedLoadLibrary := False;
  end;
{$ENDIF}
{$IFDEF POSIX}
  if GDSDLL = '' then begin
    GDSDLL := ClientLibs[FirebirdDatabaseDetected];
    hIBCLib := dlopen(PAnsiChar(AnsiString(GDSDLL)), RTLD_LAZY);
    if hIBCLib = 0 then begin
      GDSDLL := ClientLibs[not FirebirdDatabaseDetected];
      hIBCLib := dlopen(PAnsiChar(AnsiString(GDSDLL)), RTLD_LAZY);
      if hIBCLib = 0 then
...
{$IFDEF UNIX}
  if GDSDLL = '' then
    GDSDLL := ClientLibs[True];
{$ENDIF}

{$IFDEF MSWINDOWS}
  if IBXMLDLL = '' then begin
    IBXMLDLL := {$IFDEF WIN64}IBXMLDLLName64{$ELSE}IBXMLDLLName{$ENDIF};
...
{$IFDEF LINUX}
{$IFDEF FPC}
  hIBCCrypt := dlopen('libcrypt.so', RTLD_LAZY);
  if hIBCCrypt = nil then
    raise Exception.Create('Cannot load library: libcrypt.so');
{$ENDIF}
{$ENDIF}

  if NeedLoadLibrary then
  {$IFDEF MSWINDOWS}
    hIBCLib := LoadLibraryEx(PChar(GDSDLL), 0, LOAD_WITH_ALTERED_SEARCH_PATH);
  {$ELSE}
    hIBCLib := dlopen(PAnsiChar(AnsiString(GDSDLL)), RTLD_LAZY);
...
{$ENDIF}
    if GDSDLL = '' then
      ...
      raise Exception.Create('Cannot load client library: ' + GDSDLL);

{$IFDEF MSWINDOWS}
  if (Pos('GDS32', AnsiUpperCase(GDSDLL)) = 0)
    {$IFDEF WIN64}and (Pos('IBCLIENT64', AnsiUpperCase(GDSDLL)) = 0){$ENDIF} then
    hXMLLib := 0
  else
...
{$ELSE}
{$IFDEF MACOS}
  if Pos('LIBIBTOGO.DYLIB', AnsiUpperCase(GDSDLL)) <= 0 then
    hXMLLib := 0
  else
    hXMLLib := dlopen(PAnsiChar(AnsiString(IBXMLDLL)), RTLD_LAZY);
{$ENDIF}
{$ENDIF}

  InitFunctions;
  IsClientLibraryThreadSafe := not ((ClientVersion.Version < 2.5) or ((ClientVersion.Version >= 6) and (ClientVersion.Version < 9)));
end;
...
begin
{$IFNDEF IBTOGO_STATIC}
{$IFDEF MSWINDOWS}
  if hIBCLib <> 0 then begin
    if ForceUnloadClientLibrary then begin
      if @fb_shutdown <> @NotLink then
        try
          if fb_shutdown(10000, 0) = 0 then
            FreeLibrary(hIBCLib);
        except
        end
    end
...
{$ENDIF}
  ...
  FClientVersion.VersionStr := '';
  FClientVersion.Version := 0;
end;
...
function TGDS.GetClientVersion(const ClientVersion: string): TClientVersion;
var
  i, j: integer;
  len: integer;
  VerStr: string;
  ver: array[0..3] of string;
begin
  i := 0;
  j := 1;
  Result.PlatformCode := Copy(ClientVersion, 0, 2);
  Result.Distribution := ClientVersion[4];
  VerStr := Copy(ClientVersion, 5, Length(ClientVersion) - 5);
  len := Length(VerStr);
  ver[0] := '';
  ver[1] := '';
  ver[2] := '';

  while (j <= len) and (i < 4) and (VerStr[j] <> '''') do begin
    if CharInSet(VerStr[j], ['0'..'9']) then
      ver[i] := ver[i] + VerStr[j]
    else
      Inc(i);
    Inc(j);
  end;
  ...
  if ver[0] <> '' then
    Result.Major := StrToInt(ver[0])
  else
    Result.Major := 0;
  if ver[1] <> '' then
    Result.Minor := StrToInt(ver[1])
  else
    Result.Minor := 0;
  if ver[2] <> '' then
    Result.MinorMinor := StrToInt(ver[2])
  else
    Result.MinorMinor := 0;
  if ver[3] <> '' then
    Result.Build := StrToInt(ver[3])
  else
    Result.Build := 0;

  j := Pos('firebird', VerStr);
  if j > 0 then begin
    ...
    if VerStr[j] = ' ' then
      Inc(j);
    i := j;
    while (i <= Length(VerStr)) and (VerStr[i] <> ' ') and (VerStr[i] <> #0) do
      Inc(i);

    Result.VersionStr := Copy(VerStr, j, i - j);
    Result.Version := StrToFloat(StringReplace(Result.VersionStr, '.', {$IFDEF USE_FORMATSETTINGS}FormatSettings.{$ENDIF}DecimalSeparator, []));
  end
  else begin
    Result.VersionStr := IntToStr(isc_get_client_major_version) + '.' + IntToStr(isc_get_client_minor_version);
    Result.Version := isc_get_client_major_version + (isc_get_client_minor_version / 10);
  end;
end;
...
//  isc_dsql_prepare_m := GetProc('isc_dsql_prepare_m');
  ...
  if @isc_rollback_retaining <> @NotLink then begin
    ...
    FClientVersion.Version := 5;
    FClientVersion.VersionStr := '5';
  ...
  if @isc_get_client_version <> @NotLink then begin
    ...
    FClientVersion := GetClientVersion(string(s));
  end
  else begin
  ...
  if ClientVersion.Version >= 7 then begin
    ...
    if ClientVersion.Version >= 7.1 then begin
  ...
  if ClientVersion.Version >= 9 then begin
    isc_dsql_batch_execute_immed := GetProc('isc_dsql_batch_execute_immed');
    isc_dsql_batch_execute := GetProc('isc_dsql_batch_execute');
  end
  else begin
    isc_dsql_batch_execute_immed := @NotLink;
    isc_dsql_batch_execute := @NotLink;
  end;
...
{$ENDIF}
  ...
  isc_vax_integer := GetProc('isc_vax_integer');
end;

{$IFDEF IBTOGO_STATIC}
procedure TGDS.InitIBToGoFunctions;
begin
//  BLOB_open := GetProc('BLOB_open');
//  BLOB_put := GetProc('BLOB_put');
//  BLOB_get := GetProc('BLOB_get');
...
//  Bopen := GetProc('Bopen');
//  Bopen2 := GetProc('Bopen2');
  isc_sqlcode := _isc_sqlcode;
  isc_sql_interprete := _isc_sql_interprete;
  isc_interprete := _isc_interprete;
  isc_blob_info := _isc_blob_info;
  isc_open_blob2 := _isc_open_blob2;
  isc_close_blob := _isc_close_blob;
  isc_seek_blob := _isc_seek_blob;
  isc_create_blob2 := _isc_create_blob2;
  isc_cancel_blob := _isc_cancel_blob;
  isc_get_segment := _isc_get_segment;
  isc_put_segment := _isc_put_segment;

  isc_array_gen_sdl := _isc_array_gen_sdl2;
  isc_array_get_slice := _isc_array_get_slice2;
  isc_array_lookup_bounds := _isc_array_lookup_bounds2;
  isc_array_lookup_desc := _isc_array_lookup_desc2;
  isc_array_set_desc := _isc_array_set_desc2;
  isc_array_put_slice := _isc_array_put_slice2;
  isc_blob_default_desc := _isc_blob_default_desc;
  isc_blob_gen_bpb := _isc_blob_gen_bpb;
  isc_blob_lookup_desc := _isc_blob_lookup_desc;
  isc_blob_set_desc := _isc_blob_set_desc;
  isc_decode_date := _isc_decode_date;
  isc_encode_date := _isc_encode_date;
  isc_dsql_free_statement := _isc_dsql_free_statement;
  isc_dsql_execute2 := _isc_dsql_execute2;
  isc_dsql_execute := _isc_dsql_execute;
  isc_dsql_set_cursor_name := _isc_dsql_set_cursor_name;
  isc_dsql_fetch := _isc_dsql_fetch;
  isc_dsql_sql_info := _isc_dsql_sql_info;
  isc_dsql_alloc_statement2 := _isc_dsql_alloc_statement2;
  isc_dsql_prepare := _isc_dsql_prepare;
  isc_dsql_describe_bind := _isc_dsql_describe_bind;
  isc_dsql_describe := _isc_dsql_describe;
  isc_dsql_execute_immediate := _isc_dsql_execute_immediate;
  isc_drop_database := _isc_drop_database;
  isc_detach_database := _isc_detach_database;
  isc_attach_database := _isc_attach_database;
  isc_database_info := _isc_database_info;
  isc_start_multiple := _isc_start_multiple;
  isc_commit_transaction := _isc_commit_transaction;
  isc_commit_retaining := _isc_commit_retaining;
  isc_rollback_transaction := _isc_rollback_transaction;
  isc_prepare_transaction := _isc_prepare_transaction;
  isc_prepare_transaction2 := _isc_prepare_transaction2;
  isc_transaction_info := _isc_transaction_info;
  isc_que_events := _isc_que_events;
  isc_event_counts := _isc_event_counts;
  isc_cancel_events := _isc_cancel_events;
  isc_event_block := _isc_event_block;
  isc_free := _isc_free;
//  isc_dsql_execute2_m := GetProc('isc_dsql_execute2_m');
//  isc_dsql_exec_immed3_m := GetProc('isc_dsql_exec_immed3_m');
//  isc_dsql_fetch_m := GetProc('isc_dsql_fetch_m');
...
//  isc_dsql_prepare_m := GetProc('isc_dsql_prepare_m');
  ...
  fb_cancel_operation := _isc_dsql_free_statement;
  CANCEL_OPTION := DSQL_cancel;

  fb_shutdown := @NotLink;

  isc_rollback_retaining := _isc_rollback_retaining;
  isc_decode_sql_date := _isc_decode_sql_date;
  isc_decode_sql_time := _isc_decode_sql_time;
  isc_encode_sql_date := _isc_encode_sql_date;
  isc_encode_sql_time := _isc_encode_sql_time;

  isc_get_client_version := _isc_get_client_version;
  isc_get_client_major_version := _isc_get_client_major_version;
  isc_get_client_minor_version := _isc_get_client_minor_version;
  FClientVersion.VersionStr := IntToStr(isc_get_client_major_version) + '.' + IntToStr(isc_get_client_minor_version);
  FClientVersion.Version := isc_get_client_major_version + (isc_get_client_minor_version / 10);

  isc_blob_default_desc2 := _isc_blob_default_desc2;
  isc_blob_gen_bpb2 := _isc_blob_gen_bpb2;
  isc_blob_lookup_desc2 := _isc_blob_lookup_desc2;
  isc_blob_set_desc2 := _isc_blob_set_desc2;
  isc_release_savepoint := _isc_release_savepoint;
  isc_rollback_savepoint := _isc_rollback_savepoint;
  isc_start_savepoint := _isc_start_savepoint;

  isc_dsql_batch_execute_immed := _isc_dsql_batch_execute_immed;
  isc_dsql_batch_execute := _isc_dsql_batch_execute;

  isc_service_attach := _isc_service_attach;
  isc_service_detach := _isc_service_detach;
  isc_service_query := _isc_service_query;
  isc_service_start := _isc_service_start;

  isc_dsql_xml_fetch := @NotLink;
  isc_dsql_xml_fetch_all := @NotLink;
  isc_dsql_xml_buffer_fetch := @NotLink;

  isc_vax_integer := _isc_vax_integer;
end;
{$ENDIF}

procedure TGDS.RegisterNotification(const Event: TGDSNotificationEvent);
var
  pEvent: PNotificationRec;
  Found: boolean;
  i: integer;
begin
  ...
  try
    ...
    if not Found then begin
      New(pEvent);
      pEvent.Code := TMethod(Event).Code;
      pEvent.Data := TMethod(Event).Data;
      FNotifications.Add(pEvent);
    end;
  finally
    GDSNotificationSection.Leave;
  end;
...
procedure TGDS.UnRegisterNotification(Event: TGDSNotificationEvent);
var
  i: integer;
  pEvent: PNotificationRec;
begin
  ...
  try
    for i := 0 to FNotifications.Count - 1 do begin
      pEvent := PNotificationRec(FNotifications[i]);
      if pEvent.Data = TMethod(Event).Data then begin
        Dispose(PNotificationRec(FNotifications[i]));
...
begin
  ...
  try
    ...
    try
      ...
      SQLErrorMsg := PtrToStringGDS(MsgBuf, UseUnicode);
      ErrorMsg := '';
      Marshal.WriteByte(MsgBuf, 0);
      while isc_interprete(MsgBuf, PStatusVector) > 0 do begin
        if ErrorMsg <> '' then
          ErrorMsg := ErrorMsg + DALineSeparator;
        ErrorMsg := ErrorMsg + PtrToStringGDS(MsgBuf, UseUnicode);
      end;
    finally
      Release;
    end;
...
//  with TBSTREAM(p^) do begin
//    Dec(bstr_cnt);
//    if (x = {$IFNDEF NEXTGEN}#13{$ELSE}13{$ENDIF}) or (bstr_cnt = 0) then
//      Result := BLOB_put(x, p)
//    else begin
//      {$IFNDEF NEXTGEN}PAnsiChar{$ELSE}PByte{$ENDIF}(bstr_ptr)^ := x;
//      Result := UInt(x);
//      Inc(PAnsiChar(bstr_ptr)^);
//    end;
// end;
...
//      Result := BLOB_put(x, p)
//    else begin
//      {$IFNDEF NEXTGEN}PAnsiChar{$ELSE}PByte{$ENDIF}(bstr_ptr)^ := {$IFNDEF NEXTGEN}AnsiChar{$ENDIF}(x);
//      Inc(PAnsiChar(bstr_ptr)^);
//      Result := UInt(x);
//    end;
//  end;
...
begin
  ...
  if Result then begin
    if IsFirebird then
      CodePage := CharSetMap[CharSetID].FBCodePage
    else
      CodePage := CharSetMap[CharSetID].IBCodePage;
    Result := true;
    Exit;
  end;
end;
...
function Utf8ToWsNew(Source: IntPtr; SourceBytes: integer;
  Dest: IntPtr; MaxDestBytes{w/wo #0}: integer;
  AddNull: boolean = True): integer{bytes w/wo #0};

  function Utf8ToWideChar(CodePage, Flags: Cardinal; LocaleStr: IntPtr;
    LocaleStrLen: Integer; UnicodeStr: IntPtr; UnicodeStrLen: Integer): Integer;
  begin
  {$IFDEF FPC}
  {$IFNDEF MSWINDOWS}
    Result := 0;
...
begin
  ...
  Result := Utf8ToWideChar(CP_UTF8, 0, Source, SourceBytes, nil, 0);
  ...
  Result := Utf8ToWideChar(CP_UTF8, 0, Source, SourceBytes,
    Buf, Result);
...
function Utf8ToWsOld(Source: IntPtr; SourceBytes: integer;
  Dest: IntPtr; MaxDestBytes{w/wo #0}: integer;
  AddNull: boolean = True): integer{bytes w/wo #0};
var
  i: integer;
...
begin
  {$IFDEF FPC}
  {$IFDEF MSWINDOWS}
    Result := Utf8ToWsNew(Source, SourceBytes, Dest, MaxDestBytes, AddNull);
  {$ELSE}
    Result := Utf8ToWsOld(Source, SourceBytes, Dest, MaxDestBytes, AddNull); // To-Do FPC Posix: widestringmanager.Ansi2UnicodeMoveProc
  {$ENDIF}
  {$ELSE}
  {$IFNDEF LINUX}
    Result := Utf8ToWsNew(Source, SourceBytes, Dest, MaxDestBytes, AddNull);
  {$ELSE}
    Result := Utf8ToWsOld(Source, SourceBytes, Dest, MaxDestBytes, AddNull);
  {$ENDIF}
  {$ENDIF}
end;
...
function Utf8ToAnsi(Source: IntPtr; SrcLen: integer): AnsiString;
var
  DestBuf: IntPtr;
  WideStr: WideString;
  Len: integer;
begin
  DestBuf := Marshal.AllocHGlobal(SrcLen * 2);
  try
    Len := Utf8ToWs(Source, SrcLen, DestBuf, (SrcLen - 1) * 2, False);
    WideStr := Marshal.PtrToStringUni(DestBuf, Len div 2);
...
begin
  ...
  if Source = nil then
    ...
    utfBuff := Encoding.UTF8.GetBytes(Marshal.PtrToStringUni(Source));
...
begin
  if UseUnicode then begin
    Str := CRFunctions.UTF8Encode(WideString(S));
    Size := LengthA(Str) + 1;
    GetMem(Result, Size);
...
function PtrToStringGDS(P: IntPtr; Size: integer; UseUnicode: boolean): string;
var
  Str: AnsiString;
begin
  if UseUnicode then begin
    Str := Marshal.PtrToStringAnsi(P, Size);
    Result := string(CRFunctions.Utf8Decode(Str));
  end
  else
    Result := string(Marshal.PtrToStringAnsi(P, Size));
end;

function PtrToStringGDS(P: IntPtr; UseUnicode: boolean): string;
begin
  if UseUnicode then begin
    Result := string(CRFunctions.Utf8Decode({$IFNDEF NEXTGEN}PAnsiChar{$ELSE}AnsiString{$ENDIF}(P)));
  end
  else
...
{$ENDIF}
  ...
  GDSNotificationSection := TCriticalSection.Create;

finalization

  GDSList.Free;
  GDSNotificationSection.Free;
