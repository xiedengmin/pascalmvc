...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\14.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio XE6\Demos\ThirdParty\FastReport\FR4\Delphi20\

rem FastReport 4 LibD20 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD20
