...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\16.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio XE8\Demos\ThirdParty\FastReport\FR4\Delphi22\

rem FastReport 4 LibD22 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD22
