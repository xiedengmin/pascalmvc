...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\15.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio XE7\Demos\ThirdParty\FastReport\FR4\Delphi21\

rem FastReport 4 LibD21 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD21
