...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\11.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio XE4\Demos\ThirdParty\FastReport\FR4\Delphi18\

rem FastReport 4 LibD18 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD18
