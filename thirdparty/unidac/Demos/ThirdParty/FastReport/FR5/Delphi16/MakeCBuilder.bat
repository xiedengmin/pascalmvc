...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\9.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio XE2\Demos\ThirdParty\FastReport\FR4\Delphi16\

rem FastReport 4 LibD16 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD16
